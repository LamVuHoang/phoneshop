                ...
                <ul class="nav" id="main-menu">
                    ...
                    @endif
                        ...
                        {{-- <ul class="nav nav-second-level">
                            <li>
                                <a href="{{url('quan-ly/chart/san-pham')}}">Sản phẩm</a>
                            </li>
                            <li>
                    ...
                    waves-effect waves-dark">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('quan-ly/sp-va-dh') }}">Sản phẩm</a>
                            </li>
                            {{-- <li>
                                <a href="#">Loại Sản phẩm</a>
                            </li>
                            ...
                            <li>
                                <a href="{{url('quan-ly/don-hang')}}">Đơn Hàng</a>
                            </li>
                            {{-- <li>
                    ...
                    {{-- <li>
                        <a href="tab-panel.html" class="waves-effect waves-dark">
                            <i class="fa fa-bell-o"></i>Bình luận
                        </a>
                    </li>
                    <li>
